...
import { getBlog1Data, BLOG1_PATH } from "@/lib/i18n/getBlog1Data";
...
export async function generateMetadata({
  ...
  const canonicalUrl = `${baseUrl}${getLocalizedPath(BLOG1_PATH, locale)}`;
...
export default async function MostExpensiveDiamondShapesLocalePage({
  params,
}: {
  params?: Promise<{ locale?: string }>;
}) {
  ...
  return <MostExpensiveDiamondShapes locale={locale} />;
}
