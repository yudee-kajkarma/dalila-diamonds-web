...
import { getBlog4Data, BLOG4_PATH } from "@/lib/i18n/getBlog4Data";
...
export async function generateMetadata({
  ...
  const canonicalUrl = `${baseUrl}${getLocalizedPath(BLOG4_PATH, locale)}`;
...
export default async function FancyShapedDiamondCutQualityLocalePage({
  params,
}: {
  params?: Promise<{ locale?: string }>;
}) {
  ...
  return <FancyShapedDiamondCutQuality locale={locale} />;
}
