...
import rawPageData from "@/data/blogs/blog3/en.json";
import { LOCALES, DEFAULT_LOCALE, getLocalizedPath } from "@/lib/i18n/config";
import { BLOG3_PATH } from "@/lib/i18n/getBlog3Data";
...
export default function BestDiamondColourClarityCombinationPage() {
  return <BestDiamondColourClarityCombination />;
}
