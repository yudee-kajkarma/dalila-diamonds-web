...
const enContent: Ds4uContent = {
  ...
  hero: {
    ...
    imageSrc: s3Asset("/diamonds_source/diamondsourceforyou.jpg"),
  ...
  process: {
    ...
    imageSrc: s3Asset("/diamonds_source/We_Search_Our_Worldwide_Network.jpg"),
  ...
  requestTypes: {
    ...
    imageSrc: s3Asset("/diamonds_source/handshake.jpg"),
...
export const DS4U_HERO_IMAGE_URL =
  s3Asset("/diamonds_source/diamondsourceforyou.jpg");
