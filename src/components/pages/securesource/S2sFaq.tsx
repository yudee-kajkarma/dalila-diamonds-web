...
interface S2sFaqProps {
  content: S2sContent["faqs"];
}

export default function S2sFaq({ content }: S2sFaqProps) {
  return (
    <section className="bg-white py-12 md:py-16" aria-labelledby="s2s-faq-heading">
