...
import { getCuletGuideData, type CuletGuidePageData } from "@/lib/i18n/getCuletGuideData";
...
function buildStructuredDataGraph(data: CuletGuidePageData, locale: Locale) {
...
interface DiamondCuletGuideProps {
  locale?: Locale;
}

export default function DiamondCuletGuide({ locale = "en" }: DiamondCuletGuideProps) {
  const data = getCuletGuideData(locale);
  ...
  return (
    <main className={`${marcellus.variable} ${jost.variable} bg-white min-h-screen`}>
      ...
      <div className="container mx-auto max-w-7xl px-4 py-8">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <article className="flex-1 w-full min-w-0">
            ...
            <div className="mb-12">
              <AnimatedContainer direction="up">
                <nav className="bg-white scroll-mt-28" aria-labelledby="culet-guide-overview-nav">
                  <div className="w-24 h-1.5 bg-linear-to-r from-[#c89e3a] to-[#e4c75f] mb-6 rounded-full" />
                  <h2
                    id="culet-guide-overview-nav"
            ...
            {renderSection({
              ...
              children: (
                <>
                  ...
                  <BulletList items={data.whereLocated.displacedBullets} />
                  <PlainParagraphs items={data.whereLocated.closingNote} />
                  {"richClosingParagraphs" in data.whereLocated && data.whereLocated.richClosingParagraphs ? (
                    <RichParagraphList
                      paragraphs={data.whereLocated.richClosingParagraphs as RichSegment[][]}
                      locale={locale}
                    />
                  ) : null}
                </>
            ...
            {renderSection({
              id: data.whyHaveCulets.id,
              title: data.whyHaveCulets.title,
              paragraphsBefore: data.whyHaveCulets.introParagraphs,
            })}
            {data.whyHaveCulets.subsections.map((subsection) => renderSubsection(subsection, locale))}

            {renderSection({
              id: data.pointedClosedOpen.id,
              title: data.pointedClosedOpen.title,
              paragraphsBefore: data.pointedClosedOpen.introParagraphs,
              table: data.pointedClosedOpen.table,
            })}
            {data.pointedClosedOpen.subsections.map((subsection) => renderSubsection(subsection, locale))}
            ...
            {renderSection({
              id: data.appearance.id,
              title: data.appearance.title,
              paragraphsBefore: data.appearance.introParagraphs,
            })}
            {data.appearance.subsections.map((subsection) => renderSubsection(subsection, locale))}

            {renderSection({
              id: data.cutGrade.id,
              title: data.cutGrade.title,
              paragraphsBefore: data.cutGrade.introParagraphs,
              bullets: data.cutGrade.bullets,
              paragraphsAfter: data.cutGrade.closingParagraphs,
            })}
            {data.cutGrade.subsections.map((subsection) => renderSubsection(subsection, locale))}

            {renderSection({
              id: data.centredOffCentre.id,
              title: data.centredOffCentre.title,
              paragraphsBefore: data.centredOffCentre.introParagraphs,
              bullets: data.centredOffCentre.bullets,
              paragraphsAfter: data.centredOffCentre.closingParagraphs,
            })}
            {data.centredOffCentre.subsections.map((subsection) => renderSubsection(subsection, locale))}
            ...
            {renderSection({
              id: data.antique.id,
              title: data.antique.title,
              paragraphsBefore: data.antique.introParagraphs,
              children: (
                <RichParagraphList
                  paragraphs={data.antique.richClosingParagraphs as RichSegment[][]}
                  locale={locale}
                />
              ),
            })}
            {data.antique.subsections.map((subsection) => renderSubsection(subsection, locale))}
            ...
            {renderSection({
              id: data.vsOtherFeatures.id,
              title: data.vsOtherFeatures.title,
              paragraphsBefore: data.vsOtherFeatures.introParagraphs,
              table: data.vsOtherFeatures.table,
            })}
      ...
      {/* FAQ */}
      <section className="bg-white py-12 md:py-16" aria-labelledby="culet-guide-faq-heading">
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <div className="w-24 h-1.5 bg-linear-to-r from-[#c89e3a] to-[#e4c75f] mb-6 rounded-full" />
            <h2
              id="culet-guide-faq-heading"
      ...
      <section
        ...
        aria-labelledby="culet-guide-final-takeaway-heading"
      >
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <div className="w-24 h-1.5 bg-linear-to-r from-[#c89e3a] to-[#e4c75f] mb-6 rounded-full" />
            <h2
              id="culet-guide-final-takeaway-heading"
