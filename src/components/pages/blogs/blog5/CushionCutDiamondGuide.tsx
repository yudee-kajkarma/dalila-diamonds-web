...
import { getBlog5Data, type Blog5PageData, BLOG5_PATH } from "@/lib/i18n/getBlog5Data";
...
function buildStructuredDataGraph(data: Blog5PageData, locale: Locale) {
  const pageUrl = `${WEBSITE_ORIGIN}${localizedPath(BLOG5_PATH, locale)}`;
...
interface CushionCutDiamondGuideProps {
  locale?: Locale;
}

export default function CushionCutDiamondGuide({
  locale = "en",
}: CushionCutDiamondGuideProps) {
  ...
  return (
    <main className={`${marcellus.variable} ${jost.variable} bg-white min-h-screen`}>
      ...
      {/* Hero */}
      <section className="bg-white pb-10 md:pb-14" aria-labelledby="blog5-hero-heading">
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <h1
              id="blog5-hero-heading"
      ...
      <section
        ...
        aria-labelledby="blog5-quick-answer"
      >
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <h2
              id="blog5-quick-answer"
      ...
      <section className="max-w-7xl mx-auto px-6 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-12 items-start">
            ...
            <div className="mb-6">
              ...
              <ul className="space-y-4">
                {staticArticles.map((article, index) => {
                  const isActive = article.path === BLOG5_PATH;
                  return (
                    <li key={article.id}>
                      <Link
          ...
          <article className="flex-1 order-1 lg:order-2 min-w-0">
            ...
            <div className="mb-12">
              <AnimatedContainer direction="up">
                <nav className="bg-white scroll-mt-28" aria-labelledby="blog5-overview-nav">
                  <div className="w-24 h-1.5 bg-linear-to-r from-[#c89e3a] to-[#e4c75f] mb-6 rounded-full" />
                  <h2
                    id="blog5-overview-nav"
            ...
            {renderSection({
              ...
              children: data.whatIs.subsections.map((subsection) => renderSubsection(subsection, locale)),
            })}

            {renderSection({
              id: data.cushionVsShape.id,
              title: data.cushionVsShape.title,
              paragraphsBefore: data.cushionVsShape.introParagraphs,
              bullets: data.cushionVsShape.bullets,
              paragraphsAfter: data.cushionVsShape.closingParagraphs,
            })}

            {renderSection({
              id: data.brilliantVsModified.id,
              title: data.brilliantVsModified.title,
              paragraphsBefore: data.brilliantVsModified.introParagraphs,
            })}
            {data.brilliantVsModified.subsections.map((subsection) => renderSubsection(subsection, locale))}

            {renderSection({
              id: data.crushedIce.id,
              title: data.crushedIce.title,
              paragraphsBefore: data.crushedIce.introParagraphs,
              bullets: data.crushedIce.bullets,
              paragraphsAfter: data.crushedIce.closingParagraphs,
              children: (
                <>
                  <BulletList items={data.crushedIce.closingBullets} />
                  <PlainParagraphs items={data.crushedIce.finalParagraphs} />
                </>
              ),
            })}

            {renderSection({
              id: data.squareVsElongated.id,
              title: data.squareVsElongated.title,
              paragraphsBefore: data.squareVsElongated.introParagraphs,
            })}
            {data.squareVsElongated.subsections.map((subsection) => renderSubsection(subsection, locale))}

            {renderSection({
              id: data.lengthToWidth.id,
              title: data.lengthToWidth.title,
              paragraphsBefore: data.lengthToWidth.introParagraphs,
              table: data.lengthToWidth.table,
              paragraphsAfter: data.lengthToWidth.closingParagraphs,
            })}

            {renderSection({
              id: data.idealRatio.id,
              title: data.idealRatio.title,
              paragraphsBefore: data.idealRatio.introParagraphs,
              bullets: data.idealRatio.bullets,
              paragraphsAfter: data.idealRatio.closingParagraphs,
            })}

            {renderSection({
              id: data.doesGiaGrade.id,
              title: data.doesGiaGrade.title,
              paragraphsBefore: data.doesGiaGrade.introParagraphs,
              bullets: data.doesGiaGrade.bullets,
              paragraphsAfter: data.doesGiaGrade.closingParagraphs,
              children: (
                <>
                  <BulletList items={data.doesGiaGrade.closingBullets} />
                  <RichParagraphList
                    paragraphs={data.doesGiaGrade.richClosingParagraphs as RichSegment[][]}
                    locale={locale}
                  />
                </>
              ),
            ...
            {renderSection({
              id: data.howToReadReport.id,
              title: data.howToReadReport.title,
              paragraphsBefore: data.howToReadReport.introParagraphs,
              children: (
                <>
                  {data.howToReadReport.subsections.map((subsection) => renderSubsection(subsection, locale))}
                  <RichParagraphList
                    paragraphs={data.howToReadReport.richClosingParagraphs as RichSegment[][]}
                    locale={locale}
                  />
                </>
              ),
            ...
            {renderSection({
              id: data.tableDepthCharts.id,
              title: data.tableDepthCharts.title,
              paragraphsBefore: data.tableDepthCharts.introParagraphs,
              bullets: data.tableDepthCharts.bullets,
              paragraphsAfter: data.tableDepthCharts.closingParagraphs,
            })}

            {renderSection({
              id: data.evaluateQuality.id,
              title: data.evaluateQuality.title,
              paragraphsBefore: data.evaluateQuality.introParagraphs,
            })}
            {data.evaluateQuality.subsections.map((subsection) =>
              renderSubsection(subsection as Subsection, locale)
            )}

            {renderSection({
              id: data.broadVsCrushedIce.id,
              title: data.broadVsCrushedIce.title,
              paragraphsBefore: data.broadVsCrushedIce.introParagraphs,
              table: data.broadVsCrushedIce.table,
              paragraphsAfter: data.broadVsCrushedIce.closingParagraphs,
            })}

            {renderSection({
              id: data.bestColour.id,
              title: data.bestColour.title,
              paragraphsBefore: data.bestColour.introParagraphs,
              bullets: data.bestColour.bullets,
              paragraphsAfter: data.bestColour.closingParagraphs,
              children: (
                <>
                  <DataTable table={data.bestColour.table} />
                  <PlainParagraphs items={data.bestColour.finalParagraphs} />
                  <RichParagraphList
                    paragraphs={data.bestColour.richClosingParagraphs as RichSegment[][]}
                    locale={locale}
                  />
                </>
              ),
            ...
            {renderSection({
              id: data.bestClarity.id,
              title: data.bestClarity.title,
              paragraphsBefore: data.bestClarity.introParagraphs,
              bullets: data.bestClarity.bullets,
              paragraphsAfter: data.bestClarity.closingParagraphs,
              children: (
                <>
                  <BulletList items={data.bestClarity.closingBullets} />
                  <PlainParagraphs items={data.bestClarity.finalParagraphs} />
                  <RichParagraphList
                    paragraphs={data.bestClarity.richClosingParagraphs as RichSegment[][]}
                    locale={locale}
                  />
                </>
              ),
            ...
            {renderSection({
              id: data.looksLarge.id,
              title: data.looksLarge.title,
              paragraphsBefore: data.looksLarge.introParagraphs,
              bullets: data.looksLarge.bullets,
              paragraphsAfter: data.looksLarge.closingParagraphs,
              children: (
                <>
                  <BulletList items={data.looksLarge.closingBullets} />
                  <PlainParagraphs items={data.looksLarge.finalParagraphs} />
                </>
              ),
            })}

            {renderSection({
              id: data.sizeComparison.id,
              title: data.sizeComparison.title,
              paragraphsBefore: data.sizeComparison.introParagraphs,
              table: data.sizeComparison.table,
              paragraphsAfter: data.sizeComparison.closingParagraphs,
            })}

            {renderSection({
              id: data.vsRadiant.id,
              title: data.vsRadiant.title,
              paragraphsBefore: data.vsRadiant.introParagraphs,
              table: data.vsRadiant.table,
              paragraphsAfter: data.vsRadiant.closingParagraphs,
              children: (
                <>
                  <BulletList items={data.vsRadiant.closingBullets} />
                  <PlainParagraphs items={data.vsRadiant.finalParagraphs} />
                </>
              ),
            })}

            {renderSection({
              id: data.vsPrincess.id,
              title: data.vsPrincess.title,
              paragraphsBefore: data.vsPrincess.introParagraphs,
              bullets: data.vsPrincess.bullets,
              paragraphsAfter: data.vsPrincess.closingParagraphs,
              children: (
                <>
                  <BulletList items={data.vsPrincess.closingBullets} />
                  <PlainParagraphs items={data.vsPrincess.finalParagraphs} />
                </>
              ),
            })}

            {renderSection({
              id: data.vsOldMine.id,
              title: data.vsOldMine.title,
              paragraphsBefore: data.vsOldMine.introParagraphs,
              bullets: data.vsOldMine.bullets,
              paragraphsAfter: data.vsOldMine.closingParagraphs,
              children: (
                <>
                  <BulletList items={data.vsOldMine.closingBullets} />
                  <PlainParagraphs items={data.vsOldMine.finalParagraphs} />
                </>
              ),
            })}

            {renderSection({
              id: data.bestSettings.id,
              title: data.bestSettings.title,
              paragraphsBefore: data.bestSettings.introParagraphs,
            })}
            {data.bestSettings.subsections.map((subsection) => renderSubsection(subsection, locale))}

            {renderSection({
              id: data.whichMetal.id,
              title: data.whichMetal.title,
              paragraphsBefore: data.whichMetal.introParagraphs,
            })}
            {data.whichMetal.subsections.map((subsection) => renderSubsection(subsection, locale))}

            {renderSection({
              id: data.whatMakesExpensive.id,
              title: data.whatMakesExpensive.title,
              paragraphsBefore: data.whatMakesExpensive.introParagraphs,
              bullets: data.whatMakesExpensive.bullets,
              paragraphsAfter: data.whatMakesExpensive.closingParagraphs,
            })}

            {renderSection({
              id: data.buyingDecisionTable.id,
              title: data.buyingDecisionTable.title,
              paragraphsBefore: data.buyingDecisionTable.introParagraphs,
              table: data.buyingDecisionTable.table,
            })}
            ...
            {renderSection({
              ...
              paragraphsAfter: data.warningSigns.closingParagraphs,
            })}
            ...
            {data.commonMistakes.subsections.map((subsection) => renderSubsection(subsection, locale))}
            ...
            {renderSection({
              ...
              children: (
                <>
                  <BulletList items={data.finalAnswer.closingBullets} />
                  <PlainParagraphs items={data.finalAnswer.finalParagraphs} />
                </>
              ),
            })}
          </article>
      ...
      {/* FAQ */}
      <section className="bg-white py-12 md:py-16" aria-labelledby="blog5-faq-heading">
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <div className="w-24 h-1.5 bg-linear-to-r from-[#c89e3a] to-[#e4c75f] mb-6 rounded-full" />
            <h2
              id="blog5-faq-heading"
      ...
      <section
        ...
        aria-labelledby="blog5-final-takeaway-heading"
      >
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <div className="w-24 h-1.5 bg-linear-to-r from-[#c89e3a] to-[#e4c75f] mb-6 rounded-full" />
            <h2
              id="blog5-final-takeaway-heading"
