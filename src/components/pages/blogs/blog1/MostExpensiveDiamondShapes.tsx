...
import { getBlog1Data, type Blog1PageData, BLOG1_PATH } from "@/lib/i18n/getBlog1Data";
...
function buildStructuredDataGraph(data: Blog1PageData, locale: Locale) {
  const pageUrl = `${WEBSITE_ORIGIN}${localizedPath(BLOG1_PATH, locale)}`;
...
interface MostExpensiveDiamondShapesProps {
  locale?: Locale;
}

export default function MostExpensiveDiamondShapes({
  locale = "en",
}: MostExpensiveDiamondShapesProps) {
  const data = getBlog1Data(locale);
  ...
  return (
    <main className={`${marcellus.variable} ${jost.variable} bg-white min-h-screen`}>
      ...
      {/* Hero */}
      <section className="bg-white pb-10 md:pb-14" aria-labelledby="blog1-hero-heading">
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <h1
              id="blog1-hero-heading"
      ...
      <section
        ...
        aria-labelledby="blog1-quick-answer"
      >
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <h2
              id="blog1-quick-answer"
      ...
      <section className="max-w-7xl mx-auto px-6 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-12 items-start">
            ...
            <div className="mb-6">
              ...
              <ul className="space-y-4">
                {staticArticles.map((article, index) => {
                  const isActive = article.path === BLOG1_PATH;
                  return (
                    <li key={article.id}>
                      <Link
          ...
          <article className="flex-1 order-1 lg:order-2 min-w-0">
            ...
            <div className="mb-12">
              <AnimatedContainer direction="up">
                <nav className="bg-white scroll-mt-28" aria-labelledby="blog1-overview-nav">
                  <div className="w-24 h-1.5 bg-linear-to-r from-[#c89e3a] to-[#e4c75f] mb-6 rounded-full" />
                  <h2
                    id="blog1-overview-nav"
            ...
            {renderSection({
              id: data.shapeVsCut.id,
              title: data.shapeVsCut.title,
              paragraphsBefore: data.shapeVsCut.introParagraphs,
              children: (
                <RichParagraphList
                  paragraphs={data.shapeVsCut.richClosingParagraphs as RichSegment[][]}
                  locale={locale}
                />
              ),
            })}
            ...
            {renderSection({
              id: data.shapesByPrice.id,
              title: data.shapesByPrice.title,
              paragraphsBefore: data.shapesByPrice.introParagraphs,
              table: data.shapesByPrice.table,
              paragraphsAfter: data.shapesByPrice.closingParagraphs,
            })}

            {renderSection({
              id: data.whyRoundExpensive.id,
              title: data.whyRoundExpensive.title,
              paragraphsBefore: data.whyRoundExpensive.introParagraphs,
            })}
            {data.whyRoundExpensive.subsections.map((subsection) => renderSubsection(subsection))}

            {renderSection({
              id: data.ovalSecondMost.id,
              title: data.ovalSecondMost.title,
              paragraphsBefore: data.ovalSecondMost.introParagraphs,
              bullets: data.ovalSecondMost.bullets,
              paragraphsAfter: data.ovalSecondMost.closingParagraphs,
            })}

            {renderSection({
              id: data.pearMarquise.id,
              title: data.pearMarquise.title,
              paragraphsBefore: data.pearMarquise.introParagraphs,
              bullets: data.pearMarquise.bullets,
              children: (
                <RichParagraphList
                  paragraphs={data.pearMarquise.richClosingParagraphs as RichSegment[][]}
                  locale={locale}
                />
              ),
            })}
            ...
            {renderSection({
              id: data.cushionRadiantPrincess.id,
              title: data.cushionRadiantPrincess.title,
              paragraphsBefore: data.cushionRadiantPrincess.introParagraphs,
              children: (
                <>
                  {data.cushionRadiantPrincess.subsections.map((subsection) =>
                    renderSubsection(subsection)
                  )}
                  <RichParagraphList
                    paragraphs={data.cushionRadiantPrincess.richClosingParagraphs as RichSegment[][]}
                    locale={locale}
                  />
                </>
              ),
            ...
            {renderSection({
              id: data.emeraldAsscher.id,
              title: data.emeraldAsscher.title,
              paragraphsBefore: data.emeraldAsscher.introParagraphs,
            })}

            {renderSection({
              id: data.heartShaped.id,
              title: data.heartShaped.title,
              paragraphsBefore: data.heartShaped.introParagraphs,
            })}

            {renderSection({
              id: data.looksBiggest.id,
              title: data.looksBiggest.title,
              paragraphsBefore: data.looksBiggest.introParagraphs,
              bullets: data.looksBiggest.bullets,
              paragraphsAfter: data.looksBiggest.closingParagraphs,
              children: <BulletList items={data.looksBiggest.closingBullets} />,
            })}

            {renderSection({
              id: data.mostExpensiveBest.id,
              title: data.mostExpensiveBest.title,
              paragraphsBefore: data.mostExpensiveBest.introParagraphs,
            })}

            {renderSection({
              id: data.howToCompare.id,
              title: data.howToCompare.title,
              paragraphsBefore: data.howToCompare.introParagraphs,
            })}
            {data.howToCompare.subsections.map((subsection) => renderSubsection(subsection))}

            {renderSection({
              id: data.wholesaleChecklist.id,
              title: data.wholesaleChecklist.title,
              paragraphsBefore: data.wholesaleChecklist.introParagraphs,
              bullets: data.wholesaleChecklist.items,
              paragraphsAfter: data.wholesaleChecklist.closingParagraphs,
            })}
            ...
            {renderSection({
              ...
              paragraphsAfter: data.antwerpPerspective.closingParagraphs,
              children: (
                <RichParagraphList
      ...
      {/* FAQ */}
      <section className="bg-white py-12 md:py-16" aria-labelledby="blog1-faq-heading">
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <div className="w-24 h-1.5 bg-linear-to-r from-[#c89e3a] to-[#e4c75f] mb-6 rounded-full" />
            <h2
              id="blog1-faq-heading"
      ...
      <section
        ...
        aria-labelledby="blog1-final-takeaway-heading"
      >
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <div className="w-24 h-1.5 bg-linear-to-r from-[#c89e3a] to-[#e4c75f] mb-6 rounded-full" />
            <h2
              id="blog1-final-takeaway-heading"
