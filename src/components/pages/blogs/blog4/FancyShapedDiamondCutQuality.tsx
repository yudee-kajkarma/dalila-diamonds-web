...
import { getBlog4Data, type Blog4PageData, BLOG4_PATH } from "@/lib/i18n/getBlog4Data";
...
function buildStructuredDataGraph(data: Blog4PageData, locale: Locale) {
  const pageUrl = `${WEBSITE_ORIGIN}${localizedPath(BLOG4_PATH, locale)}`;
...
interface FancyShapedDiamondCutQualityProps {
  locale?: Locale;
}

export default function FancyShapedDiamondCutQuality({
  locale = "en",
}: FancyShapedDiamondCutQualityProps) {
  const data = getBlog4Data(locale);
  ...
  return (
    <main className={`${marcellus.variable} ${jost.variable} bg-white min-h-screen`}>
      ...
      {/* Hero */}
      <section className="bg-white pb-10 md:pb-14" aria-labelledby="blog4-hero-heading">
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <h1
              id="blog4-hero-heading"
      ...
      <section
        ...
        aria-labelledby="blog4-quick-answer"
      >
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <h2
              id="blog4-quick-answer"
      ...
      <section className="max-w-7xl mx-auto px-6 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-12 items-start">
            ...
            <div className="mb-6">
              ...
              <ul className="space-y-4">
                {staticArticles.map((article, index) => {
                  const isActive = article.path === BLOG4_PATH;
                  return (
                    <li key={article.id}>
                      <Link
          ...
          <article className="flex-1 order-1 lg:order-2 min-w-0">
            ...
            <div className="mb-12">
              <AnimatedContainer direction="up">
                <nav className="bg-white scroll-mt-28" aria-labelledby="blog4-overview-nav">
                  <div className="w-24 h-1.5 bg-linear-to-r from-[#c89e3a] to-[#e4c75f] mb-6 rounded-full" />
                  <h2
                    id="blog4-overview-nav"
            ...
            {renderSection({
              id: data.firstCheckLab.id,
              title: data.firstCheckLab.title,
              paragraphsBefore: data.firstCheckLab.introParagraphs,
              children: (
                <>
                  {data.firstCheckLab.subsections.map((subsection) => renderSubsection(subsection))}
                  <RichParagraphList
                    paragraphs={data.firstCheckLab.richClosingParagraphs as RichSegment[][]}
                    locale={locale}
                  />
                </>
              ),
            ...
            {renderSection({
              id: data.fancyShapeVsColour.id,
              title: data.fancyShapeVsColour.title,
              paragraphsBefore: data.fancyShapeVsColour.introParagraphs,
              bullets: data.fancyShapeVsColour.bullets,
              paragraphsAfter: data.fancyShapeVsColour.closingParagraphs,
            })}

            {renderSection({
              id: data.reportCanCannot.id,
              title: data.reportCanCannot.title,
              paragraphsBefore: data.reportCanCannot.introParagraphs,
              table: data.reportCanCannot.table,
              paragraphsAfter: data.reportCanCannot.closingParagraphs,
              children: (
                <RichParagraphList
                  paragraphs={data.reportCanCannot.richClosingParagraphs as RichSegment[][]}
                  locale={locale}
                />
              ),
            })}
            ...
            {renderSection({
              id: data.comparisonProcess.id,
              title: data.comparisonProcess.title,
              paragraphsBefore: data.comparisonProcess.introParagraphs,
              children: (
                <>
                  {data.comparisonProcess.subsections.map((subsection) => renderSubsection(subsection))}
                  <RichParagraphList
                    paragraphs={data.comparisonProcess.richClosingParagraphs as RichSegment[][]}
                    locale={locale}
                  />
                </>
              ),
            ...
            {renderSection({
              id: data.lightPerformanceNoEquipment.id,
              title: data.lightPerformanceNoEquipment.title,
              paragraphsBefore: data.lightPerformanceNoEquipment.introParagraphs,
            })}
            {data.lightPerformanceNoEquipment.subsections.map((subsection) =>
              renderSubsection(subsection)
            )}

            {renderSection({
              id: data.bowTie.id,
              title: data.bowTie.title,
              paragraphsBefore: data.bowTie.introParagraphs,
              bullets: data.bowTie.bullets,
              paragraphsAfter: data.bowTie.closingParagraphs,
              children: (
                <RichParagraphList
                  paragraphs={data.bowTie.richClosingParagraphs as RichSegment[][]}
                  locale={locale}
                />
              ),
            })}
            ...
            {renderSection({
              id: data.windowing.id,
              title: data.windowing.title,
              paragraphsBefore: data.windowing.introParagraphs,
              bullets: data.windowing.bullets,
              paragraphsAfter: data.windowing.closingParagraphs,
            })}

            {renderSection({
              id: data.evaluateEachShape.id,
              title: data.evaluateEachShape.title,
              paragraphsBefore: data.evaluateEachShape.introParagraphs,
            })}
            {data.evaluateEachShape.subsections.map((subsection) => renderSubsection(subsection))}

            {renderSection({
              id: data.polishSymmetryNotEnough.id,
              title: data.polishSymmetryNotEnough.title,
              paragraphsBefore: data.polishSymmetryNotEnough.introParagraphs,
              bullets: data.polishSymmetryNotEnough.bullets,
              paragraphsAfter: data.polishSymmetryNotEnough.closingParagraphs,
            })}

            {renderSection({
              id: data.comparisonWorksheet.id,
              title: data.comparisonWorksheet.title,
              paragraphsBefore: data.comparisonWorksheet.introParagraphs,
              table: data.comparisonWorksheet.table,
              paragraphsAfter: data.comparisonWorksheet.closingParagraphs,
            })}
      ...
      {/* FAQ */}
      <section className="bg-white py-12 md:py-16" aria-labelledby="blog4-faq-heading">
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <div className="w-24 h-1.5 bg-linear-to-r from-[#c89e3a] to-[#e4c75f] mb-6 rounded-full" />
            <h2
              id="blog4-faq-heading"
      ...
      <section
        ...
        aria-labelledby="blog4-final-takeaway-heading"
      >
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <div className="w-24 h-1.5 bg-linear-to-r from-[#c89e3a] to-[#e4c75f] mb-6 rounded-full" />
            <h2
              id="blog4-final-takeaway-heading"
