...
import { getBlog3Data, type Blog3PageData, BLOG3_PATH } from "@/lib/i18n/getBlog3Data";
...
function buildStructuredDataGraph(data: Blog3PageData, locale: Locale) {
  const pageUrl = `${WEBSITE_ORIGIN}${localizedPath(BLOG3_PATH, locale)}`;
...
interface BestDiamondColourClarityCombinationProps {
  locale?: Locale;
}

export default function BestDiamondColourClarityCombination({
  locale = "en",
}: BestDiamondColourClarityCombinationProps) {
  ...
  return (
    <main className={`${marcellus.variable} ${jost.variable} bg-white min-h-screen`}>
      ...
      {/* Hero */}
      <section className="bg-white pb-10 md:pb-14" aria-labelledby="blog3-hero-heading">
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <h1
              id="blog3-hero-heading"
      ...
      <section
        ...
        aria-labelledby="blog3-quick-answer"
      >
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <h2
              id="blog3-quick-answer"
      ...
      <section className="max-w-7xl mx-auto px-6 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-12 items-start">
            ...
            <div className="mb-6">
              ...
              <ul className="space-y-4">
                {staticArticles.map((article, index) => {
                  const isActive = article.path === BLOG3_PATH;
                  return (
                    <li key={article.id}>
                      <Link
          ...
          <article className="flex-1 order-1 lg:order-2 min-w-0">
            ...
            <BulletList items={data.introduction.bullets} />
            <PlainParagraphs items={data.introduction.closingParagraphs} />

            {renderSection({
              id: data.bestAtAGlance.id,
              title: data.bestAtAGlance.title,
              paragraphsBefore: data.bestAtAGlance.introParagraphs,
              table: data.bestAtAGlance.table,
              paragraphsAfter: data.bestAtAGlance.closingParagraphs,
            })}

            {renderSection({
              id: "blog3-key-takeaways",
            ...
            <div className="mb-12">
              <AnimatedContainer direction="up">
                <nav className="bg-white scroll-mt-28" aria-labelledby="blog3-overview-nav">
                  <div className="w-24 h-1.5 bg-linear-to-r from-[#c89e3a] to-[#e4c75f] mb-6 rounded-full" />
                  <h2
                    id="blog3-overview-nav"
            ...
            {renderSection({
              id: data.understandingColour.id,
              title: data.understandingColour.title,
              paragraphsBefore: data.understandingColour.introParagraphs,
              table: data.understandingColour.table,
              paragraphsAfter: data.understandingColour.closingParagraphs,
              children: (
                <>
                  <BulletList items={data.understandingColour.closingBullets} />
                  <RichParagraphList
                    paragraphs={data.understandingColour.richClosingParagraphs as RichSegment[][]}
                    locale={locale}
                  />
                </>
              ),
            ...
            {renderSection({
              id: data.understandingClarity.id,
              title: data.understandingClarity.title,
              paragraphsBefore: data.understandingClarity.introParagraphs,
              table: data.understandingClarity.table,
              paragraphsAfter: data.understandingClarity.closingParagraphs,
              children: (
                <>
                  <BulletList items={data.understandingClarity.closingBullets} />
                  <PlainParagraphs items={data.understandingClarity.finalParagraphs} />
                  <RichParagraphList
                    paragraphs={data.understandingClarity.richClosingParagraphs as RichSegment[][]}
                    locale={locale}
                  />
                </>
              ),
            ...
            {renderSection({
              id: data.whyGhVs2.id,
              title: data.whyGhVs2.title,
              paragraphsBefore: data.whyGhVs2.introParagraphs,
              bullets: data.whyGhVs2.bullets,
              paragraphsAfter: data.whyGhVs2.closingParagraphs,
              children: (
                <>
                  <BulletList items={data.whyGhVs2.closingBullets} />
                  <PlainParagraphs items={data.whyGhVs2.finalParagraphs} />
                  <RichParagraphList
                    paragraphs={data.whyGhVs2.richClosingParagraphs as RichSegment[][]}
                    locale={locale}
                  />
                </>
              ),
            ...
            {renderSection({
              id: data.gVs2OrHVs2.id,
              title: data.gVs2OrHVs2.title,
              paragraphsBefore: data.gVs2OrHVs2.introParagraphs,
              bullets: data.gVs2OrHVs2.gBullets,
              children: (
                <>
                  <p
                    className={`text-gray-700 text-base md:text-lg leading-relaxed mb-6 font-medium ${jost.className}`}
                  >
                    {data.gVs2OrHVs2.hIntro}
                  </p>
                  <BulletList items={data.gVs2OrHVs2.hBullets} />
                  <PlainParagraphs items={data.gVs2OrHVs2.closingParagraphs} />
                </>
              ),
            })}

            {renderSection({
              id: data.hSi1Value.id,
              title: data.hSi1Value.title,
              paragraphsBefore: data.hSi1Value.introParagraphs,
              bullets: data.hSi1Value.bullets,
              paragraphsAfter: data.hSi1Value.closingParagraphs,
            })}

            {renderSection({
              id: data.whyNotDAndFlawless.id,
              title: data.whyNotDAndFlawless.title,
              paragraphsBefore: data.whyNotDAndFlawless.introParagraphs,
              bullets: data.whyNotDAndFlawless.bullets,
              paragraphsAfter: data.whyNotDAndFlawless.closingParagraphs,
              children: (
                <>
                  <BulletList items={data.whyNotDAndFlawless.closingBullets} />
                  <PlainParagraphs items={data.whyNotDAndFlawless.finalParagraphs} />
                  <BulletList items={data.whyNotDAndFlawless.finalBullets} />
                  <RichParagraphList
                    paragraphs={data.whyNotDAndFlawless.richClosingParagraphs as RichSegment[][]}
                    locale={locale}
                  />
                </>
              ),
            ...
            {renderSection({
              id: data.shapeChangesCombination.id,
              title: data.shapeChangesCombination.title,
              paragraphsBefore: data.shapeChangesCombination.introParagraphs,
            })}
            {data.shapeChangesCombination.subsections.map((subsection) =>
              renderSubsection(subsection)
            )}

            {renderSection({
              id: data.caratWeightDecision.id,
              title: data.caratWeightDecision.title,
              paragraphsBefore: data.caratWeightDecision.introParagraphs,
              bullets: data.caratWeightDecision.bullets,
              children: (
                <>
                  <PlainParagraphs items={data.caratWeightDecision.closingParagraphs} />
                  <DataTable table={data.caratWeightDecision.table} />
                  <PlainParagraphs items={data.caratWeightDecision.finalParagraphs} />
                </>
              ),
            })}

            {renderSection({
              id: data.metalColour.id,
              title: data.metalColour.title,
              paragraphsBefore: data.metalColour.introParagraphs,
            })}
            {data.metalColour.subsections.map((subsection) => renderSubsection(subsection))}

            {renderSection({
              id: data.sideStones.id,
              title: data.sideStones.title,
              paragraphsBefore: data.sideStones.introParagraphs,
              bullets: data.sideStones.bullets,
              paragraphsAfter: data.sideStones.closingParagraphs,
            })}

            {renderSection({
              id: data.prioritiseColourOrClarity.id,
              title: data.prioritiseColourOrClarity.title,
              paragraphsBefore: data.prioritiseColourOrClarity.introParagraphs,
              bullets: data.prioritiseColourOrClarity.colourBullets,
              children: (
                <>
                  <p
                    className={`text-gray-700 text-base md:text-lg leading-relaxed mb-6 font-medium ${jost.className}`}
                  >
                    {data.prioritiseColourOrClarity.clarityIntro}
                  </p>
                  <BulletList items={data.prioritiseColourOrClarity.clarityBullets} />
                  <PlainParagraphs items={data.prioritiseColourOrClarity.closingParagraphs} />
                </>
              ),
            })}
            ...
            {renderSection({
              id: data.cutFirst.id,
              title: data.cutFirst.title,
              paragraphsBefore: data.cutFirst.introParagraphs,
              bullets: data.cutFirst.bullets,
              children: (
                <RichParagraphList
                  paragraphs={data.cutFirst.richClosingParagraphs as RichSegment[][]}
                  locale={locale}
                />
              ),
            })}
            ...
            {renderSection({
              id: data.fluorescence.id,
              title: data.fluorescence.title,
              paragraphsBefore: data.fluorescence.introParagraphs,
              bullets: data.fluorescence.bullets,
              paragraphsAfter: data.fluorescence.closingParagraphs,
            })}

            {renderSection({
              id: data.retailInventory.id,
              title: data.retailInventory.title,
              paragraphsBefore: data.retailInventory.introParagraphs,
              bullets: data.retailInventory.coreBullets,
              children: (
                <>
                  <p
                    className={`text-gray-700 text-base md:text-lg leading-relaxed mb-6 font-medium ${jost.className}`}
                  >
                    {data.retailInventory.stepCutIntro}
                  </p>
                  <BulletList items={data.retailInventory.stepCutBullets} />
                  <p
                    className={`text-gray-700 text-base md:text-lg leading-relaxed mb-6 font-medium ${jost.className}`}
                  >
                    {data.retailInventory.premiumIntro}
                  </p>
                  <BulletList items={data.retailInventory.premiumBullets} />
                  <p
                    className={`text-gray-700 text-base md:text-lg leading-relaxed mb-6 font-medium ${jost.className}`}
                  >
                    {data.retailInventory.valueIntro}
                  </p>
                  <BulletList items={data.retailInventory.valueBullets} />
                  <PlainParagraphs items={data.retailInventory.closingParagraphs} />
                </>
              ),
            })}
            ...
            {data.commonMistakes.subsections.map((subsection) => renderSubsection(subsection))}
            ...
            {renderSection({
              ...
              paragraphsAfter: data.buyingChecklist.closingParagraphs,
            })}
      ...
      {/* FAQ */}
      <section className="bg-white py-12 md:py-16" aria-labelledby="blog3-faq-heading">
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <div className="w-24 h-1.5 bg-linear-to-r from-[#c89e3a] to-[#e4c75f] mb-6 rounded-full" />
            <h2
              id="blog3-faq-heading"
      ...
      <section
        ...
        aria-labelledby="blog3-final-takeaway-heading"
      >
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <div className="w-24 h-1.5 bg-linear-to-r from-[#c89e3a] to-[#e4c75f] mb-6 rounded-full" />
            <h2
              id="blog3-final-takeaway-heading"
