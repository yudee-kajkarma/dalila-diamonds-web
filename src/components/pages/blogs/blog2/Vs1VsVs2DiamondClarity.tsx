...
function buildStructuredDataGraph(data: Blog2PageData, locale: Locale) {
  const pageUrl = `${WEBSITE_ORIGIN}${localizedPath(BLOG2_PATH, locale)}`;
...
interface Vs1VsVs2DiamondClarityProps {
  locale?: Locale;
}

export default function Vs1VsVs2DiamondClarity({
  locale = "en",
}: Vs1VsVs2DiamondClarityProps) {
  ...
  return (
    <main className={`${marcellus.variable} ${jost.variable} bg-white min-h-screen`}>
      ...
      {/* Hero */}
      <section className="bg-white pb-10 md:pb-14" aria-labelledby="blog2-hero-heading">
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <h1
              id="blog2-hero-heading"
      ...
      <section
        ...
        aria-labelledby="blog2-quick-answer"
      >
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <h2
              id="blog2-quick-answer"
      ...
      <section className="max-w-7xl mx-auto px-6 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-12 items-start">
            ...
            <div className="mb-6">
              ...
              <ul className="space-y-4">
                {staticArticles.map((article, index) => {
                  const isActive = article.path === BLOG2_PATH;
                  return (
                    <li key={article.id}>
                      <Link
          ...
          <article className="flex-1 order-1 lg:order-2 min-w-0">
            ...
            <div className="mb-12">
              <AnimatedContainer direction="up">
                <nav className="bg-white scroll-mt-28" aria-labelledby="blog2-overview-nav">
                  <div className="w-24 h-1.5 bg-linear-to-r from-[#c89e3a] to-[#e4c75f] mb-6 rounded-full" />
                  <h2
                    id="blog2-overview-nav"
            ...
            {renderSection({
              id: data.whatDoesVsMean.id,
              title: data.whatDoesVsMean.title,
              paragraphsBefore: data.whatDoesVsMean.introParagraphs,
              table: data.whatDoesVsMean.table,
              children: (
                <RichParagraphList
                  paragraphs={data.whatDoesVsMean.richClosingParagraphs as RichSegment[][]}
                  locale={locale}
                />
              ),
            })}
            ...
            {renderSection({
              id: data.directComparison.id,
              title: data.directComparison.title,
              paragraphsBefore: data.directComparison.introParagraphs,
              table: data.directComparison.table,
              paragraphsAfter: data.directComparison.closingParagraphs,
            })}

            {renderSection({
              id: data.canYouSeeDifference.id,
              title: data.canYouSeeDifference.title,
              paragraphsBefore: data.canYouSeeDifference.introParagraphs,
              bullets: data.canYouSeeDifference.bullets,
              paragraphsAfter: data.canYouSeeDifference.closingParagraphs,
            })}

            {renderSection({
              id: data.howGradesDetermined.id,
              title: data.howGradesDetermined.title,
              paragraphsBefore: data.howGradesDetermined.introParagraphs,
            })}
            {data.howGradesDetermined.subsections.map((subsection) => renderSubsection(subsection))}

            {renderSection({
              id: data.whatInclusions.id,
              title: data.whatInclusions.title,
              paragraphsBefore: data.whatInclusions.introParagraphs,
            })}
            {data.whatInclusions.subsections.map((subsection) => renderSubsection(subsection))}

            {renderSection({
              id: data.whyTwoVs2LookDifferent.id,
              title: data.whyTwoVs2LookDifferent.title,
              paragraphsBefore: data.whyTwoVs2LookDifferent.introParagraphs,
            })}

            {renderSection({
              id: data.isVs2QualityGood.id,
              title: data.isVs2QualityGood.title,
              paragraphsBefore: data.isVs2QualityGood.introParagraphs,
              bullets: data.isVs2QualityGood.bullets,
              paragraphsAfter: data.isVs2QualityGood.closingParagraphs,
            })}

            {renderSection({
              id: data.isVs2AlwaysEyeClean.id,
              title: data.isVs2AlwaysEyeClean.title,
              paragraphsBefore: data.isVs2AlwaysEyeClean.introParagraphs,
              bullets: data.isVs2AlwaysEyeClean.bullets,
              paragraphsAfter: data.isVs2AlwaysEyeClean.closingParagraphs,
              children: (
                <>
                  <BulletList items={data.isVs2AlwaysEyeClean.closingBullets} />
                  <PlainParagraphs items={data.isVs2AlwaysEyeClean.finalParagraphs} />
                </>
              ),
            })}

            {renderSection({
              id: data.shapeAffectsDecision.id,
              title: data.shapeAffectsDecision.title,
              paragraphsBefore: data.shapeAffectsDecision.introParagraphs,
            })}
            {data.shapeAffectsDecision.subsections.map((subsection) => renderSubsection(subsection))}

            {renderSection({
              id: data.caratWeightVisibility.id,
              title: data.caratWeightVisibility.title,
              paragraphsBefore: data.caratWeightVisibility.introParagraphs,
            })}

            {renderSection({
              id: data.isVs1WorthMore.id,
              title: data.isVs1WorthMore.title,
              paragraphsBefore: data.isVs1WorthMore.introParagraphs,
              bullets: data.isVs1WorthMore.bullets,
              paragraphsAfter: data.isVs1WorthMore.closingParagraphs,
              children: <BulletList items={data.isVs1WorthMore.closingBullets} />,
            })}

            {renderSection({
              id: data.whichOffersBetterValue.id,
              title: data.whichOffersBetterValue.title,
              paragraphsBefore: data.whichOffersBetterValue.introParagraphs,
              bullets: data.whichOffersBetterValue.bullets,
              paragraphsAfter: data.whichOffersBetterValue.closingParagraphs,
              children: (
                <>
                  <BulletList items={data.whichOffersBetterValue.closingBullets} />
                  <PlainParagraphs items={data.whichOffersBetterValue.finalParagraphs} />
                </>
              ),
            })}

            {renderSection({
              id: data.higherClaritySparkle.id,
              title: data.higherClaritySparkle.title,
              paragraphsBefore: data.higherClaritySparkle.introParagraphs,
              children: (
                <RichParagraphList
                  paragraphs={data.higherClaritySparkle.richClosingParagraphs as RichSegment[][]}
                  locale={locale}
                />
              ),
            })}
            ...
            {renderSection({
              id: data.vs2Durability.id,
              title: data.vs2Durability.title,
              paragraphsBefore: data.vs2Durability.introParagraphs,
              bullets: data.vs2Durability.bullets,
              paragraphsAfter: data.vs2Durability.closingParagraphs,
            })}

            {renderSection({
              id: data.clarityPlot.id,
              title: data.clarityPlot.title,
              paragraphsBefore: data.clarityPlot.introParagraphs,
              bullets: data.clarityPlot.bullets,
              paragraphsAfter: data.clarityPlot.closingParagraphs,
              children: (
                <RichParagraphList
                  paragraphs={data.clarityPlot.richClosingParagraphs as RichSegment[][]}
                  locale={locale}
                />
              ),
            })}
            ...
            {renderSection({
              id: data.retailerGuidance.id,
              title: data.retailerGuidance.title,
              paragraphsBefore: data.retailerGuidance.introParagraphs,
              bullets: data.retailerGuidance.vs2Bullets,
              children: (
                <>
                  <p
                    className={`text-gray-700 text-base md:text-lg leading-relaxed mb-6 font-medium ${jost.className}`}
                  >
                    {data.retailerGuidance.vs1Intro}
                  </p>
                  <BulletList items={data.retailerGuidance.vs1Bullets} />
                  <PlainParagraphs items={data.retailerGuidance.closingParagraphs} />
                </>
              ),
            })}
      ...
      {/* FAQ */}
      <section className="bg-white py-12 md:py-16" aria-labelledby="blog2-faq-heading">
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <div className="w-24 h-1.5 bg-linear-to-r from-[#c89e3a] to-[#e4c75f] mb-6 rounded-full" />
            <h2
              id="blog2-faq-heading"
      ...
      <section
        ...
        aria-labelledby="blog2-final-takeaway-heading"
      >
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedContainer direction="up">
            <div className="w-24 h-1.5 bg-linear-to-r from-[#c89e3a] to-[#e4c75f] mb-6 rounded-full" />
            <h2
              id="blog2-final-takeaway-heading"
