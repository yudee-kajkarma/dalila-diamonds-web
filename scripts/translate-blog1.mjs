...
const base = path.join(__dirname, "../src/data/blogs/blog1");
...
async function runLocale(loc, tl) {
  const cachePath = path.join(base, `.blog1-cache-${loc}.json`);
  ...
  translated.images = {
    ...
    roughYield: { ...en.images.roughYield, alt: translated.images.roughYield.alt },
    priceDrivers: { ...en.images.priceDrivers, alt: translated.images.priceDrivers.alt },
    faceUpSize: { ...en.images.faceUpSize, alt: translated.images.faceUpSize.alt },
    logo: en.images.logo,
  };
