...
const base = path.join(__dirname, "../src/data/blogs/blog7");
...
async function runLocale(loc, tl) {
  const cachePath = path.join(base, `.blog7-cache-${loc}.json`);
  ...
  translated.images = {
    ...
    annotatedReport: {
      ...en.images.annotatedReport,
      alt: translated.images.annotatedReport.alt,
    },
    verificationProcess: {
      ...en.images.verificationProcess,
      alt: translated.images.verificationProcess.alt,
    },
    laserInscription: {
      ...en.images.laserInscription,
      alt: translated.images.laserInscription.alt,
    },
    inconsistencyMap: {
      ...en.images.inconsistencyMap,
      alt: translated.images.inconsistencyMap.alt,
    },
    logo: en.images.logo,
  };
