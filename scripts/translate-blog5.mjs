...
const base = path.join(__dirname, "../src/data/blogs/blog5");
...
async function runLocale(loc, tl) {
  const cachePath = path.join(base, `.blog5-cache-${loc}.json`);
  ...
  translated.images = {
    ...
    facetPatterns: {
      ...en.images.facetPatterns,
      alt: translated.images.facetPatterns.alt,
    },
    ratios: {
      ...en.images.ratios,
      alt: translated.images.ratios.alt,
    },
    inspectionMap: {
      ...en.images.inspectionMap,
      alt: translated.images.inspectionMap.alt,
    },
    logo: en.images.logo,
  };
