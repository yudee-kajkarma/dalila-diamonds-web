...
const base = path.join(__dirname, "../src/data/blogs/blog4");
...
async function runLocale(loc, tl) {
  const cachePath = path.join(base, `.blog4-cache-${loc}.json`);
  ...
  translated.images = {
    ...
    reportVisualCheck: {
      ...en.images.reportVisualCheck,
      alt: translated.images.reportVisualCheck.alt,
    },
    lightPerformance: {
      ...en.images.lightPerformance,
      alt: translated.images.lightPerformance.alt,
    },
    outlineDurability: {
      ...en.images.outlineDurability,
      alt: translated.images.outlineDurability.alt,
    },
    logo: en.images.logo,
  };
