...
const base = path.join(__dirname, "../src/data/blogs/blog2");
...
async function runLocale(loc, tl) {
  const cachePath = path.join(base, `.blog2-cache-${loc}.json`);
  ...
  // Keep asset paths/dimensions from EN, but allow translated alt text.
  translated.images = {
    featured: { ...en.images.featured, alt: translated.images.featured.alt },
    inclusionVisibility: {
      ...en.images.inclusionVisibility,
      alt: translated.images.inclusionVisibility.alt,
    },
    clarityByShape: {
      ...en.images.clarityByShape,
      alt: translated.images.clarityByShape.alt,
    },
    inspectionChecklist: {
      ...en.images.inspectionChecklist,
      alt: translated.images.inspectionChecklist.alt,
    },
    logo: en.images.logo,
  };
