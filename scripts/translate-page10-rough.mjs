...
const base = path.join(__dirname, "../src/data/diamonds/page10");
...
async function runLocale(loc, tl) {
  const cachePath = path.join(base, `.page10-cache-${loc}.json`);
  ...
  translated.images = {
    ...
    evaluation: {
      ...en.images.evaluation,
      alt: translated.images.evaluation.alt,
    },
    roughVsPolished: {
      ...en.images.roughVsPolished,
      alt: translated.images.roughVsPolished.alt,
    },
    documentation: {
      ...en.images.documentation,
      alt: translated.images.documentation.alt,
    },
    naturalVsLab: {
      ...en.images.naturalVsLab,
      alt: translated.images.naturalVsLab.alt,
    },
    logo: en.images.logo,
  };
  if (translated.banner?.breadcrumbParentHref) {
    translated.banner.breadcrumbParentHref = en.banner.breadcrumbParentHref;
  }
